...
export default function OssolLayout({ children, currentScreen, onScreenChange }: OssolLayoutProps) {
  ...
  return (
    <>
      {/* Head for OG tags */}
      <Head>
        <title>OSSOL Asset Management</title>
        <meta property="og:title" content="OSSOL Asset Management" />
        <meta property="og:description" content="Manage your assets efficiently with OSSOL" />
        <meta property="og:image" content="https://ossol-asset-management.vercel.app/logo.svg" />
        <meta property="og:image" content="https://ossol-asset-management.vercel.app/logo.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://ossol-asset-management.vercel.app" />
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <div className="flex items-center space-x-4 space-x-reverse">
                ...
                <div className="flex items-center space-x-2">
                  <Button variant={language === 'en' ? 'default' : 'outline'} size="sm" onClick={() => handleLanguageChange('en')}>EN</Button>
                  <Button variant={language === 'ar' ? 'default' : 'outline'} size="sm" onClick={() => handleLanguageChange('ar')}>ع</Button>
                </div>
                  ...
                  {showNotifications && (
                    <div className="absolute left-0 mt-2 w-80 bg-white rounded-lg shadow-lg border z-50">
                      <div className="p-4 border-b flex justify-between items-center">
                        ...
                        <Button variant="ghost" size="sm" onClick={markAllNotificationsAsRead}>{t.markAllRead}</Button>
                      </div>
